...
{
	import gearunits.models.PMeshPanelLauncher;
	 ...
	 * @author Darknet
	 */
	public class PWeaponPanelRocket extends PWeaponPanelLauncher
	{
		
		public function PWeaponPanelRocket() 
		{
			...
			mesh = new PMeshPanelLauncher(compMat);
			
			name = 'PWeaponPanelRocket';
			timemax = 10;
			detectrange = 128;
			//TurnSpeed = 5;
