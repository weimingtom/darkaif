...
// Register the member
//=================================================================================================
function register_member($firstname,$lastname,$gender,$usernameaccount,$passwordaccount,$useremail,$is_activated,$validation_code){
...
VALUES('$md_membername','$datestamp','$urip','offline','0','Member','$firstname','$lastname','$gender','$usernameaccount','$LCusername','$memberpassword','$coded_password ','$useremail','$is_activated','$validation_code')")
or die(mysql_error());
