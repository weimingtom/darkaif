...
#$target_path = "http://localhost/data/";
...
$allowed_filetypes = array('.jpg', '.gif', '.bmp', '.png','.dae', '.ase', '.md2', '.txt', '.flv','.obj','.mlt'); // These will be the types of file that will pass the validation.
$mesh_filetypes = array('.ase', '.md2', '.dae', '.3ds', '.obj', '.mlt');
...
#echo $ext;
	...
	if ($count) {
		echo '[==File Exist==]<br>'.$objectnametext.'<br>';
	}else {
