package darknet.core.display {
	...
	* 
	* Note: 3D object got to have some frame base build with out any conflict from other classes.
	* 
	*/

	public class DropBox3D extends Sprite {
