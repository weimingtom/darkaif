...
package darkaif.frame 
{
	...
	*/
	public class Framesizing extends Sprite
	{
		...
		public var blockheight:Number = 10;
		public var blockwidth:Number = 10;
		...
		public function Framesizing() 
		{
			...
			sprite_leftsizing.graphics.drawRect(0, 0, 10, fheight);
			...
			sprite_bottomrightsizing.addEventListener(MouseEvent.MOUSE_DOWN, drawsizing);
			//sprite_bottomrightsizing.addEventListener(MouseEvent.MOUSE_OVER, updatesizing);
		...
		public function updateimage():void
		{
			...
			FlashConnect.trace('updating');
			
			sprite_bottomleftsizing.graphics.clear();
			sprite_bottomleftsizing.graphics.beginFill(0xb0c4de);
			sprite_bottomleftsizing.graphics.drawRect(0, mouseY , 10, 10);
			sprite_bottomleftsizing.name = 'bottomleftsizing';
			
			sprite_bottomrightsizing.graphics.clear();
			sprite_bottomrightsizing.graphics.beginFill(0xb0c4de);
			sprite_bottomrightsizing.graphics.drawRect(fwidth, fheight, 10, 10);
			sprite_bottomrightsizing.name = 'bottomrightsizing';
			
			sprite_toprightsizing.graphics.clear();
			sprite_toprightsizing.graphics.beginFill(0xb0c4de);
			sprite_toprightsizing.graphics.drawRect(mouseX, 0, 10, 10);
			sprite_toprightsizing.name = 'toprightsizing';
			
			sprite_topleftsizing.graphics.clear();
			sprite_topleftsizing.graphics.beginFill(0xb0c4de);
			sprite_topleftsizing.graphics.drawRect(0, 0, 10, 10);
			sprite_topleftsizing.name = 'topleftsizing';
			
			sprite_leftsizing.graphics.clear();
			sprite_leftsizing.graphics.beginFill(0x778899);
			sprite_leftsizing.graphics.drawRect(0, 0, 10, mouseY);
			sprite_leftsizing.name = 'leftsizing';
			
			sprite_rightsizing.graphics.clear();
			sprite_rightsizing.graphics.beginFill(0x778899);
			sprite_rightsizing.graphics.drawRect(mouseX, 0, 10, mouseY);
			sprite_rightsizing.name = 'rightsizing';
			
			//
			sprite_topsizing.graphics.clear();
			sprite_topsizing.graphics.beginFill(0x778899);
			sprite_topsizing.graphics.drawRect(0, 0, mouseX, 10);
			sprite_topsizing.name = 'topsizing';
			
			sprite_bottomsizing.graphics.clear();
			sprite_bottomsizing.graphics.beginFill(0x778899);
			sprite_bottomsizing.graphics.drawRect(0, mouseY, mouseX, 10);
			sprite_bottomsizing.name = 'bottomsizing';
		}
		public function updatesizing(event:MouseEvent):void
		{	
			FlashConnect.trace('Mouse ' + mouseX + ":" + mouseY );
			
			FlashConnect.trace(String(sprite_bottomrightsizing.x));
			//MouseEvent.x
		...
		public function drawsizing(event:MouseEvent):void
		{			
			//
			sprite_bottomrightsizing.startDrag();
			//
