package  
{
	import darknet.engine.sandy.model.TeleportPortal;
	import darknet.engine.sandy.model.ZonePortal;
	 ...
	 * @author Darknet
	 */
	public class SandyModel extends Sprite{
		...
		public var myshapeclass:ZonePortal = new ZonePortal();
		
		public function SandyModel(){
			//{ Scene world
			// camera
