package  programs
{
	...
	*/ 
	...
	public class SandyGUI0 extends Sprite
	{
		...
		public var box:Shape3D = new Plane3D('back', 200, 250, 10, 10, Plane3D.XY_ALIGNED, 'quad');
		public var bData:BitmapData;
		//public var buttonclearmap:DropBox = new DropBox();
		public var buttonclearmap:Button = new Button('Clear Map');
		//public var buttonclearmap2:Button = new Button('submit');
		public var g:Group = new Group();
		
		public function SandyGUI0() 
		{
			//buttonclearmap.boxlist.push("hellow");
			//buttonclearmap.boxlist.push("hellow");
			//buttonclearmap.boxlist.push("hellow");
			//buttonclearmap.boxlist.push("hellow");
			addChild(loadingbar);
		...
		private function createScene():Group {
			...
			//buttonclearmap2
			//loadingbar.addChild(buttonclearmap2);
