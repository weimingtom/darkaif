package  
{
	...
	public class SandyMeshASE extends Sprite {
		...
		private function createScene():Group {
			...
			var datafilename:String = 'data/models/cubeobj.ase';
			//var datafilename:String = 'data/models/bbasic_entrance01.ase';
			var parser:IParser = Parser.create(String(datafilename), Parser.ASE );
