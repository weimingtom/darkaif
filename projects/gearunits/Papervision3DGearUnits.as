package 
{
	...
	import gearunits.papervision3d.entity.spacecraft.PSpaceshipFedCarrier;
	import gearunits.papervision3d.entity.spacecraft.PSpacestationFedShipyard;
	...
	public class Papervision3DGearUnits extends BasicView
	{
		...
		public function buildunit():void {
			...
			buildunit = new PSpaceshipFedCarrier();
			buildunit.x = 0;
			buildunit.y = 0;
			buildunit.z = 0;
			scene.addChild(buildunit.mesh);
