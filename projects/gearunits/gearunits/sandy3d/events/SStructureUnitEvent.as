package gearunits.sandy3d.events 
{
	 ...
	 * @author Darknet
	 */
	public class SStructureUnitEvent extends Event 
	{
		...
		public function SStructureUnitEvent(type:String,value:Number, bubbles:Boolean=false, cancelable:Boolean=false) 
		{ 
