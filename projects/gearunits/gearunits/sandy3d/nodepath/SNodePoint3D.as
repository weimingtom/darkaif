package gearunits.sandy3d.nodepath 
{
	...
	public class SNodePoint3D 
	{
		...
		public function SNodePoint3D(px:Number = 0, py:Number = 0, pz:Number = 0) 
		{
			x = px;
			y = py;
			z = pz;
		...
		public function gridpoint():SNodePoint3D {
			var gridpoint:SNodePoint3D = new SNodePoint3D();
			return gridpoint
		}
		...
		public function distcost(start:SNodePoint3D, end:SNodePoint3D):void {
		...
		public function unitpointgrid(point:SStructureUnit):void {
			x = Math.floor(point.x / gridsize);
			y = Math.floor(point.y / gridsize);
			z = Math.floor(point.z / gridsize);
		}
